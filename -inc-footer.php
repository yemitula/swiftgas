									...
									<div class="col-sm-7">
										<div class="clock">
											<ul>
												...
												<li>New York - <span id="NewYork"></span> |</li>
												<li>London - <span id="GMT"></span> |</li>
												<li>Lagos - <span id="Lagos"></span> |</li>
												<li>Istanbul - <span id="Istanbul"></span> |</li>
												<li>Beijing - <span id="Beijing"></span></li>
											</ul>
										</div>
									</div>
									<div class="col-sm-1">
